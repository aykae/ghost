...
palette: {
primary: {
main: '#38A3A5', // Change the main primary color to the provided color
},
secondary: {
...
backgroundColor: '#22c55e', // button background color from the image
color: '#ffffff', // button text color
borderRadius: '8px', // button border radius
padding: '10px 24px', // button padding
'&:hover': {
backgroundColor: '#16a34a', // darker color on hover
},
},
